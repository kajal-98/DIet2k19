<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BMICalculation.aspx.cs" Inherits="_Default" MasterPageFile="~/MasterPages/Dietitian.master"%>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">


    <asp:Label ID="Label3" runat="server" Text="Label" CssClass="tdtag"></asp:Label>
    ...
    <td class="style4" colspan="2">
        ...
        <tr>
            <td colspan="2" class="style8">
                <hr style="border-style: solid; width: 1231px; margin-left: 0px;" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <asp:Label ID="Label4" runat="server" BackColor="#FFCC00" ForeColor="White"></asp:Label>
            </td>
        </tr>
    </table>
   </asp:Content>
