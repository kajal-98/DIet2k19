...
public partial class LoginPages_DietitianForgotPAssword : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        String myquery = "Select * from DietitianMaster where DUsername='" + TextBox3.Text + "' and DietitianEmailID='" + TextBox1.Text + "'";
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            password = ds.Tables[0].Rows[0]["DietitianPassword"].ToString();
