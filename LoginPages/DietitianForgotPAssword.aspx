<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/LoginPage.master" AutoEventWireup="true" CodeFile="DietitianForgotPAssword.aspx.cs" Inherits="LoginPages_DietitianForgotPAssword" %>
            ...
            <tr>
                ...
                <td class="style6">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        ControlToValidate="TextBox3" ErrorMessage="plase enter Username" 
                        ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td class="style10">
                    <asp:LinkButton ID="LinkButton1" runat="server" 
                        PostBackUrl="~/LoginPages/DietitianLogin.aspx" Height="38px" Width="161px" 
